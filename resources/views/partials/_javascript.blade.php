...
<script src="{{ URL::asset('vendor/vector-map/jquery.vmap.js') }}"></script>
<script src="{{ URL::asset('vendor/vector-map/jquery.vmap.min.js') }}"></script>
<script src="{{ URL::asset('vendor/vector-map/jquery.vmap.sampledata.js') }}"></script>
<script src="{{ URL::asset('vendor/vector-map/jquery.vmap.world.js') }}"></script>
